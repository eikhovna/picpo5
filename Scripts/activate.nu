...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\2 курс\пикпо\pikpo5\pikpo5_python_flask\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\2 курс\пикпо\pikpo5\pikpo5_python_flask\venv\Scripts\deactivate.nu'
